        ...
        <div class="row">
            <div class="col-5">
                <div class="w-100" style="width: 100px; height: auto;">
                    <img src="assets/design-in/gambar-main.jpg" style="width: 100%;">
                </div>
                <div class="row my-1">
                    <div class="col p-2">
            ...
            <div class="col-7">
                ...
                <div>
                    ...
                    <hr>
                    <div class="py-2">
                        <span style="font-size: 14px;">*Penjelasan_Jasa</span>
                    </div>
                    <hr class="mt-5">
                    <div class="row">
                        ...
                        <div class="col-3 p-0 mx-3">
                            <button class="fw-bold btn w-100 text-white py-3" style="background-color: #CF0437;">Art</button>
                        </div>
                    </div>
                    <hr>
                    <div class="row mt-4">
